...
public class OutboundImage {
	...
	// text queue name
	public void queueName(Graphics2D g2d, String inputParam9) {
		g2d.setFont(new Font("TimesNewRoman", Font.BOLD, 11));
		g2d.setColor(Color.black);
		g2d.drawString("Queue Name:  " + inputParam9, 260, 230);
	}

	// text queue Manager Name
	public void queueManagerName(Graphics2D g2d, String inputParam10) {

		// text queue Manager name
		g2d.setFont(new Font("TimesNewRoman", Font.BOLD, 11));
		g2d.setColor(Color.black);
		g2d.drawString("Queue Manager Name :"+inputParam10, 260, 245);
	}

	public void queueManagerName1(Graphics2D g2d, String inputParam10) {

		// text queue Manager name
		g2d.setFont(new Font("TimesNewRoman", Font.BOLD, 11));
		g2d.setColor(Color.black);
		g2d.drawString(inputParam10, 260, 258);
	}
	...
	public static String createReverse(String source, String target, String interfaceName, String eaiName,
		...
		image.queueName(g2d, queueName);
		if (queueManagerName.length() > 13) {
			image.queueManagerName(g2d, queueManagerName.substring(0, 13));
			image.queueManagerName1(g2d, queueManagerName.substring(13));
			
		}else{
			image.queueManagerName(g2d, queueManagerName);
		}
