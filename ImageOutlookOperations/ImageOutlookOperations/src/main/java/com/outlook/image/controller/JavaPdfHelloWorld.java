...
public class JavaPdfHelloWorld extends PdfPageEventHelper {
	...
	public void outagee(Document document, String outageePlan, String startTime) throws DocumentException {
	...
	public void conclusion(Document document, String conclusion, StringBuffer outageePlan) throws DocumentException {
	...
	public static String createPDF(java.util.List<String> imageNameList, String outageeStatus,
			java.util.List<String> interfaceNameList, java.util.List<String> senderNameList,
			java.util.List<String> receiverNameList, java.util.List<String> iFlowNameList,
			java.util.List<String> queueNameList, java.util.List<String> queueManagerNameList,
			java.util.List<String> serverNameList, java.util.List<String> environmentNameList)
		...
		PdfWriter writer = pdf.pdfWriter(doc, "Sample"+interfaceNameList.get(0)+".pdf");
		...
		pdf.outagee(doc, outageeStatus, "May 25 2 am");
		doc.newPage();
